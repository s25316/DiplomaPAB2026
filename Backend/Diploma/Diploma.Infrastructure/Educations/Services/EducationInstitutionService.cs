...
{
    IAsyncEnumerable<EducationInstitution> GetAsync([EnumeratorCancellation] CancellationToken cancellationToken = default);
}
    ...
    ) : IEducationInstitutionService
{
    ...
    public async IAsyncEnumerable<EducationInstitution> GetAsync([EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        var uri = GetUri();
