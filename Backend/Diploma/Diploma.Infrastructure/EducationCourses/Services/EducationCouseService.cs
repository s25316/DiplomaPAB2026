...
namespace Diploma.Infrastructure.EducationCourses.Services;
...
{
    IAsyncEnumerable<EducationCourse> GetAsync(
    ...
    ) : IEducationCouseService
{
    ...
    public async IAsyncEnumerable<EducationCourse> GetAsync(
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        var uri = GetUri();
