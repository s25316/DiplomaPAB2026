...
public sealed class TargetInstitutionData : BaseInstitutionData
{
    ...
    public required Guid TargetInstitutionUuid { get; init; }
    ...
    public required string TargetInstitutionName { get; init; }
}