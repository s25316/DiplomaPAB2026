...
public partial class rootDane
{
    ...
    private string fiz_dataSkresleniazRegon;
    ...
    private string fiz_dzialalnosciCeidg;

    private string fiz_dzialalnosciRolniczych;

    private string fiz_dzialalnosciPozostalych;
